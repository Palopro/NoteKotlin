package com.vladh.notekotlin.ui.activities
...
import com.vladh.notekotlin.R
import com.vladh.notekotlin.mvp.models.Note
import com.vladh.notekotlin.mvp.presenters.MainPresenter
import com.vladh.notekotlin.mvp.views.MainView
import com.vladh.notekotlin.ui.adapters.NotesAdapter
import com.vladh.notekotlin.ui.commons.ItemClickSupport
...
class MainActivity : MvpAppCompatActivity(), MainView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var fab = findViewById(R.id.fabButton) as FloatingActionButton
        //fabButton.attachToRecyclerView(rvNotesList)
        fab.setOnClickListener { mPresenter.openNewNote(this) }
    }
